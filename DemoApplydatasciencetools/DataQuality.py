...
cleaned_data['production_date'] = pd.to_datetime(cleaned_data['production_date'])

# Save cleaned data to a new CSV file
cleaned_data_path = r'C:\Users\PC\PycharmProjects\tesst\.venv\DemoFileCsv\cleaned_data.csv'
